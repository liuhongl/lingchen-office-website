      ...
      <main className="mine-geo-page">
        ...
        <section className="mine-geo-scenarios">
          <div className="mine-geo-shell">
            ...
            <div className="mine-geo-scenario-table"><div className="head"><b>落地场景</b><b>适用角色</b><b>痛点</b><b>可衡量指标 / 解决的问题</b></div><div><strong>品牌 AI 可见度审计<br/>与竞品对比</strong><span>适用对象：品牌&市场部、增长<br/>团队、公关团队</span><p>AI 答案分散且变化快，品牌可能被竞品替代推荐，或因公开资料不足而无法被准确引用。</p><p>批量监测国内外主流 AI 平台，获得全方位的可见度、推荐率、信源引用质量与情感倾向画像，精准识别优先优化的问题、平台与来源，形成 AI 答案入口基线。</p></div><div><strong>售前资料与公关内<br/>容自动生成</strong><span>适用对象：售前、市场、品牌、<br/>公关团队</span><p>产品资料多、版本迭代复杂、客户重复问题，跨多团队口径一致性差，资料和 PR 准备繁琐耗时。</p><p>基于结构化标准事实统一事实、口径、版本，自动且快速生成百科、PR 稿、FAQ、销售话术、摘要与短视频脚本，大幅缩短资料准备和改稿时间。</p></div><div><strong>AI 口碑与风险表述<br/>治理</strong><span>适用对象：品牌、公关、法务合<br/>规、客户服务团队</span><p>AI 面临错误事实表述、负向情绪倾向扩散、来源失控、口径不一致等合规风险与品牌声誉挑战。</p><p>建立 发现偏差 ➔ 补齐事实 ➔ 审核追溯 治理机制，持续追踪错误/负向回答占比与权威引用占比，使风险指标与错误回答占比显著下降。</p></div></div>
