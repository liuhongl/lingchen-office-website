  ...
  return <main className="dls-page">
    <section className="dls-hero" aria-labelledby="dls-hero-title">
      <div className="dls-hero__copy">
        ...
        <h1 id="dls-hero-title">让案件拓展与办案，<br />成为<span>可运营、可复盘</span><br />的能力</h1>
        ...
        <div className="dls-hero__features">{["全链路 同系统回流", "7×24 内容孵化案源", "分钟级 合同审阅", "越用越准 数据飞轮"].map((text)=><span key={text}><Image src={icon(42)} alt="" width={12} height={12}/>{text}</span>)}</div>
      </div>
