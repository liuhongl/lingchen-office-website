...
|---|---|---|---|---|
| DLS-R6-01 | 全页 12px 可见文字 | Hero、轨道、痛点、Agent、价值、合作、CTA 存在多组 12px 节点 | 实测可见计算字号 12px 节点为 0；目标组均为 13px | PASS |
| DLS-R6-02 | 五张痛点卡 | 图标均 40px；标题 400；副标题/正文起点因卡片内容换行不同 | 图标均 40×40；标题 700/24px；标题、副标题、正文起点逐卡一致 | PASS |
